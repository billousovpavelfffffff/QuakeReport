...
public final class QueryUtils {
    ...
    /**
     * Return a list of {@link QuakeInf} objects that has been built up from
     * parsing a JSON response.
     */
    public static ArrayList<QuakeInf> extractEarthquakes() {
        ArrayList<QuakeInf> earthquakes = new ArrayList<>();
        try {
            JSONObject quake = new JSONObject(SAMPLE_JSON_RESPONSE);
            ...
            for (int i = 0; i < features.length(); i++) {
                ...
                QuakeInf earthquake = new QuakeInf(mag, place, time);
